...
\noindent Soit \(\,\mathcal{B}=(e_1,\cdots,e_n)\,\) une base de E. La matrice \(\,G_\mathcal{B}\left(\psm{e_i}{e_j}\right)\,\) est appelée matrice dans la base \(\,\mathcal{B}\,\) du produit scalaire \ps, ou \textbf{matrice de Gram}\index{matrice de Gram}.

\vspace{1cm}

On suppose que E est \underline{orienté}. Soit \(\,x_1,\cdots,x_n\,\) des vecteurs de E. On appelle \textbf{produit mixte}\index{produit mixte} des n vecteurs \(\,x_1,\cdots,x_n\,\) le réel \(\,[x_1,\cdots,x_n]\,\) défini par :\vspace{0.1cm} \\

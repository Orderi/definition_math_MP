...
On dit que $(x_n)$ \textbf{tend vers $+\infty$}\index{suites de scalaires!limite en $+\infty$} \ssi :\(\ \ \forall A>0,\ \exists N\in \NN,\ \forall x\geq N,\ x_n\geq A\).\vspace{0.1cm}\\
On dit que $(x_n)$ \textbf{tend vers $-\infty$}\index{suites de scalaires!limite en $-\infty$} \ssi :\(\ \ \forall A>0,\ \exists N\in \NN,\ \forall x\geq N,\ x_n\leq -A\).
...
Soient $(a_n)$ et $(b_n)$ deux suites \underline{réelles}. On dit que \(\bigl((a_n),(b_n)\bigr)\) est une couple de \textbf{suites adjacentes}\index{suites adjacentes} \ssi $(a_n)$ est croissante, $(b_n)$ est décroissante et \(\displaystyle \lim \bigl(b_n-a_n\bigr)=0.\)
...
\begin{itemize}[leftmargin=0.5cm]
    ...
    \item[•] On dit que $(a_n)$ est \textbf{négligeable}\index{suites de scalaires!négligeable} devant $(b_n)$, et on note \(a_n=\text{o}(b_n)\), \ssi \(\ \displaystyle \lim \frac{a_n}{b_n}=0.  \)\\
    \begin{small}
        On dit aussi que \((a_n)\) est \underline{\emph{un}} petit o de \((b_n)\).
    \end{small}
    \vspace{0.1cm}
    
    \item[•] On dit que \((a_n)\) est \textbf{équivalente}\index{suites de scalaires!équivalente} à \((b_n)\), et on note \(a_n\sim b_n\), \ssi \(\ \displaystyle \lim\frac{a_n}{b_n}=1. \) 
\end{itemize}
...
On dit que la série \(\sum a_n\) \textbf{diverge grossièrement}\index{séries numériques!diverge grossièrement} lorsque le terme général ne tend pas vers $0$.
...
Une \textbf{série alternée}\index{série alternée} est une série dont le terme général est de la forme \((-1)^na_n\,\) où \(\,(a_n)\) est une suite de réels positifs.
...
Une famille \(\bigl(a_i\bigr)_{i\in I}\) de réels est dite \textbf{sommable}\index{famille sommable de réels} \ssi \(\bigl(a^+_i\bigr)_{i\in I}\)\footnote{\(\ \forall i\in I,\ \, a^+_i=\max \bigl(a_i, 0\bigr)\)\vspace{0.2cm}} et \(\bigl(a^-_i\bigr)_{i\in I}\)\footnote{\(\ \forall i\in I,\ \, a^-_i=\max \bigl(-a_i, 0\bigr)\)} sont sommables.\vspace{0.1cm}\\
...
Une famille \(\bigl(z_i\bigr)_{i\in I}\) de complexes est dite \textbf{sommable}\index{famille sommable de complexes} \ssi la famille \(\bigl(|z_i|\bigr)_{i\in I}\) est sommable.\vspace{0.2cm}\\
...
La série \(\sum c_n\) est appelé \textbf{produit de Cauchy}\index{produit de Cauchy} des deux séries \(\sum a_n\) et \(\sum b_n\).
...
\noindent On dit que la suite d'application \((f_n)\) \textbf{converge simplement sur A vers \(f\)}\index{suite d'applications!convergence simple} \ssi :\vspace{-0.2cm} \[ \forall x\in A,\ \lim_{n\to +\infty}f_n(x)=f(x). \]\vspace{-0cm}\\
...
\noindent On dit que la suite d'application \((f_n)\) \textbf{converge uniformément sur A vers \(f\)}\index{suite d'applications!convergence uniforme} \ssi :\vspace{-0.2cm} \[ \forall \varepsilon>0,\ \exists N\in \NN,\ \forall n\geq N,\ \forall x\in A,\ |f_n(x)-f(x)|\leq \varepsilon. \]\vspace{-0cm}\\
...
L'ensemble \(D_a = \{ z\in \CC \ \rvert \ |z|<R_a \} \) est appelé \textbf{disque ouvert de convergence}\index{disque ouvert de convergence} de  \(\sum a_nz^n\).\vspace{0.2cm}\\
L'ensemble \(C_a=\{ z\in \CC \ \rvert \ |z|=R_a \} \) est appelé \textbf{cercle d'incertitude}\index{cercle d'incertitude} de la série entière \(\sum a_nz^n\).
...
\noindent Soient \(r>0\) et \(f:\RR \to \CC\) une fonction de classe \(\CC ^\infty\) sur \(]-r,r\, [\). La série entière \(\displaystyle \sum \frac{f^{(n)}(0)}{n!}t^n\) est appelé \textbf{série de Taylor}\index{série de Taylor} de \(f\) en 0.

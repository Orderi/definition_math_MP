...
\begin{itemize}[label=•]
    ...
    \(f\) est dite \textbf{minorée}\index{fonctions à valeurs scalaires!minorée} sur E \ssi : \(\ \exists m\in \RR \ | \ \forall x \in E,\ f(x)\geq m.\)\vspace{0.4cm}
    ...
    \(f\) est dite \textbf{monotone}\index{fonctions à valeurs scalaires!monotone} sur E \ssi \(f\) est décroissante ou croissante sur E.\newpage
    ...
    On dit que \(f\) est \textbf{périodique}\index{fonction périodique} \ssi \(f\) admet au moins une période non nulle.\vspace{0.4cm}
...
En cas d'existence, l'application $f^{(n)}$ est appelée \textbf{dérivée n}\expo{ième}\index{fonctions à valeurs scalaires!dérivée n\expo{ième}} de $f$. L'application $f$ est dite \textbf{indéfiniment dérivable}\index{fonctions à valeurs scalaires!indéfiniment dérivable} sur I \ssi pour tout \(n\in \NN\), $f$ est $n$-fois dérivable sur I. 

\vspace{1.3cm}

Soient \(\,f:I\to \KK\,\) une application et \(\,a\in I\). Si $f$ est $n$-fois dérivable en $a$ alors on appelle \textbf{polynôme de Taylor}\index{polynôme de Taylor} de $f$ en $a$ à l'ordre $n$ la fonction polynomiale $\,T_{n,f,a}\,$ définie par : \vspace{-0.1cm}
...
\underline{\emph{Théorème - définition}} : \textbf{Sommes de Riemann.}\index{sommes de Riemann}\vspace{0.1cm}\\

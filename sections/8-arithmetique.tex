...
Un \textbf{nombre premier}\index{nombre premier} est un entier naturel distinct de 1 dont les seuls diviseurs dans $\NN$ sont 1 et lui-même. On note $\mathcal{P}\,$ l'ensemble des nombres premiers.
...
\begin{itemize}[leftmargin=0.5cm]
    ...
    \item[•] On note \(\,\mathcal{D}_A\,\) l'ensemble des \textbf{diviseurs}\index{diviseurs polynômiaux} de A, cet ensemble contient toujours\, K\ind{0}$[$X$]$.\\
...
On dit que $a$ et $b$ sont \textbf{associés}\index{éléments associés} dans A \ssi :\, $a\mid b\:$ et $\:b\mid a$.
...
\noindent Deux éléments $a$ et $b$ de A sont dits \textbf{premiers entre eux}\index{Arithmétique dans $\,\bigl(A,\,+,\,\times\bigr)$!premiers entre eux} \ssi\, 1\ind{A}\, est un pgcd de $a$ et $b$.
